...
#figure(
  image("figures/state_monthly_temp_trends_2.png", width: 80%),
...
#figure(
  image("figures/state_monthly_temp_trends_3.png", width: 80%),
...
#figure(
  image("figures/state_monthly_temp_trends_4.png", width: 80%),
...
#figure(
  image("figures/state_monthly_temp_trends_5.png", width: 80%),
...
#figure(
  image("figures/state_monthly_temp_trends_6.png", width: 80%),
